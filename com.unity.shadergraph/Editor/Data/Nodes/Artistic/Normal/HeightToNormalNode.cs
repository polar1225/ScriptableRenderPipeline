...
namespace UnityEditor.ShaderGraph
{
    ...
    [Title("Artistic", "Normal", "Height To Normal")]
    public class HeightToNormalNode : AbstractMaterialNode, IGeneratesBodyCode, IGeneratesFunction, IMayRequireTangent, IMayRequireBitangent, IMayRequireNormal, IMayRequirePosition
    {
        ...
        {
            return string.Format("Unity_HeightToNormal_{0}", outputSpace.ToString());
        }

        public sealed override void UpdateNodeAfterDeserialization()
        {
            AddSlot(new Vector3MaterialSlot(InputSlotId, kInputSlotName, kInputSlotName, SlotType.Input, Vector4.zero));
